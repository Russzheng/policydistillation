...
python distilledqn_atari.py PongNoFrameskip-v4 PongNoFrameskip-v4_greyscale_huber_student_test -sl mse_prob -ptq softmax_tau -ctq none -ep boltzmann -stqt 0.01 -tcd $TEACHER_CHECKPOINT_DIR -tcn $TEACHER_NAME
