...
python distilledqn_atari.py PongNoFrameskip-v4 PongNoFrameskip-v4_greyscale_huber_teacher -sl mse_prob -ptq softmax_tau -ctq none -ep bayesian -stqt 0.01 -tcd $TEACHER_CHECKPOINT_DIR -tcn $TEACHER_NAME